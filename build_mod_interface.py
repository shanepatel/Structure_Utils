...
str_files=commands.getoutput('find . -iname "*.F90" |sort')
...
files.remove('./modules/interface_mod.F90')
files.remove('./wrappers/energyandforces_siesta.f90')
files.remove('./wrappers/energyandforces_openmx.f90')
files.remove('./src/MPIfake.F90')
files.remove('./src/task_netsock.F90')
